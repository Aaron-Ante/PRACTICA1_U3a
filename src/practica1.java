...
public class practica1 extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
     ...
     if( obj.Insertar(valor) == false){
          jLabel1.setText( "ERROR: Pila llena");
            ...
            jLabel1.setText("Elemento insertado");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        boolean resp = obj.Eliminar();
        if(resp == false){
           jLabel1.setText("ERROR:Pila vacia");
        }else{
             jLabel1.setText( "TOP Eliminado: "+obj.mostrarx());
        }
        mostrarPila();
    }                                        
        private void mostrarPila(){
           int copia  =obj.getTope();
           int[] copiadata  =obj.mostrar();
           String contenido = "";
           for(int i = copia; i>=0; i--){
               contenido+="["+ i+"]"+"= TOP:"+copiadata[i]+"\n";
           }
